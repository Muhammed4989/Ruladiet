...
const courses = [
  ...
  },
  {
    ...
    chapters: [
      { title: 'مقدمة وأساسيات', lessons: ['مقدمة', 'ما معنى اللخبطة الحقيقية في الدورة الشهرية', 'أسباب اللخبطة في الدورة الشهرية', 'فشل المبايض المبكر', 'هرمون الحليب', 'هل يصيب ارتفاع هرمون الحليب الرجال ؟', 'ما هي متلازمة تكيس المبايض ؟', 'أعراض تكيس المبايض', 'تشخيص تكيس المبايض', 'هل التكيس يعني الإصابة بالمتلازمة', 'معلومة لطيفة'] },
      { title: 'التحاليل والأسئلة الشائعة', lessons: ['متى نقوم بعمل التحاليل', 'أسئلة شائعة حول التكيس', 'الفرق بين الكيس والتكيس'] },
      { title: 'العلاج والأدوية', lessons: ['علاج التكيس', 'الحبوب الهرمونية', 'فئات يمنع عليها أخذ حبوب أستروجين مع بروجسترون', 'الأعراض الجانبية لحبوب منع الحمل', 'الفحوصات اللازمة قبل أخذ الحبوب', 'أهم الأسئلة حول أدوية التكيس', 'الميتفورمين والجلوكوفاج', 'لو كان المنظم يسبب إقياء غثيان إسهال', 'متى تؤخذ المكملات وماهي'] },
      { title: 'الوزن والتغذية', lessons: ['الوزن وعلاقته بتكيس المبايض', 'كيف نعرف تناسب الوزن مع الطول', 'هل مقاومة الأنسولين تمنع نزول الوزن', 'النظام الغذائي لتكيسات المبايض', 'أدوية خسارة الوزن', 'فئات يمنع عليها استخدام الإبر', 'ملاحظات حول أدوية خسارة الوزن'] },
      { title: 'الحمل والإنجاب', lessons: ['الحمل وتكيس المبايض', 'تحاليل التبويض', 'زيادة فرص الحمل بعلاج تكيس المبايض', 'أسئلة عامة حول الحمل والتبويض'] }
    ],
    infoCards: [
      { title: 'المواد المرفقة', items: ['34 فيديو مسجّل تشرح كل المواضيع', 'ملخصات مكتوبة لأهم النقاط', 'جداول عملية لمتابعة الوزن والتحاليل', 'قائمة مكملات وأدوية مع شرح الاستعمال', 'إجابات على الأسئلة الشائعة'] },
    ...
    includes: ['34 درس فيديو', '6+ ساعات محتوى', 'ملخصات مكتوبة', 'وصول مدى الحياة', 'متاح على الجوال'],
    metaLessons: '34 درس',
    metaDuration: '6+ ساعات',
    metaLevel: 'جميع المستويات',
    metaInstructor: 'رولا علوش',
    price: '$247',
    priceLabel: 'دورة متخصصة',
    whatsappText: 'الاستفسار عن كورس تكيس المبايض',
    heroDuration: '6+ ساعات',
    heroWeeks: '34 درس',
